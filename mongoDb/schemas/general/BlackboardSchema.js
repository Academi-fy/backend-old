 ...
 * @param {String} state - The state of the blackboard. Valid states are: 'SUGGESTED', 'APPROVED', 'APPROVED', 'EDIT_SUGGESTED', 'EDIT_APPROVED', 'EDIT_APPROVED', 'DELETE_SUGGESTED', 'DELETE_APPROVED', 'DELETE_APPROVED'
